...
function setup() {
  ...
  leftWall = new Base(100, height - 900, 400, height / 2 + 100);
  rightWall = new Base(width - 100, height - 900, 200, height / 2 + 100);

  bridge = new Bridge(22, { x: 50, y: height / 2 - 140 });
  jointPoint = new Base(width - 250, height / 2 - 100, 70, 20);
